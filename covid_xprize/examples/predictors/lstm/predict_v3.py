...
MODEL_WEIGHTS_FILE = os.path.join(ROOT_DIR, "models", "trained_lstm_plus_vp_model_weights.h5")

DATA_FILE = os.path.join(ROOT_DIR, 'data', "OxCGRT_latest_plus_vp.csv")
...
def predict(start_date: str,
    ...
    """
    # !!! YOUR CODE HERE !!!
    predictor = XPrizePredictorV3(MODEL_WEIGHTS_FILE, DATA_FILE)
