...
# If you'd like to use a model, copy it to "lstm_vp_trained_model_weights.h5"
# or change this MODEL_FILE path to point to your model.
MODEL_WEIGHTS_FILE = os.path.join(ROOT_DIR, "models", "trained_lstm_plus_vpsum_model_weights.h5")

DATA_FILE = os.path.join(ROOT_DIR, 'data', "OxCGRT_latest_plus_vpsum.csv")
...
def predict(start_date: str,
    ...
    """
    # !!! YOUR CODE HERE !!!
    predictor = XPrizePredictorV2(MODEL_WEIGHTS_FILE, DATA_FILE)
